...
<?php for($t=1; $t<=$countpage; $t++){?>
		...
		<table width="800" align="center">
			<tr height="15" align="left" >
				<td width="250" style="font-family:'宋体'; font-size:14px;height:20px;">销货单位：<?php echo $contactNo.' '.$contactName?> </td>
				<td width="10" ></td>
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
				...
				<tr style="height:20px">
					...
					<td width="250" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">结算帐号</td> 
					<td width="150" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">收款金额</td>
					<td width="150" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">结算方式</td>
					<td width="150" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">结算号</td>
			   ...
			   ?>
				<tr style="height:20px">
					...
					<td width="250"><?php echo $row['accName'];?></td>
					<td width="150" align="right"><?php echo str_money($row['payment'],2)?></td>
					<td width="150"><?php echo $row['wayName'];?></td>
					<td width="150"><?php echo $row['settlement'];?></td>
					<td width="250" align="left"><?php echo $row['remark']?></td>
				</tr>
				<?php 
				    $s = $row['i'];
				    }
