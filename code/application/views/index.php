...
<div id="container" class="cf">
  <div id="col-side">
    ...
    <li class="item item-vip"> <a href="javascript:void(0);" class="vip main-nav">高级<span class="arrow">&gt;</span></a>
      ...
      <li class="item item-purchase"> <a href="javascript:void(0);" class="purchase main-nav">進貨span class="arrow">&gt;</span></a>
  ...
  <div id="col-main">
    <div id="main-hd" class="cf">
      ...
      <ul class="user-menu">
      	...
      	<li class="space">|</li>
      	<li class="qq"><a href="" onClick="return false;" id="wpa">QQ咨询：151188441</a></li>
      	<li class="space">|</li>
        
      	<li class="telphone">电话：15818768802</li>
        <li class="space">|</li>-->
      	<li id="sysSkin">版面風格</li>
        <li class="space">|</li>
         <!-- 
       ...
       <!-- <li><a href="" target="_blank">帮助</a></li>
        <li class="space">|</li>-->
        <li><a href="<?php echo site_url('login/out')?>">登出</a></li>
      </ul>  
    </div>
    <div id="main-bd">
