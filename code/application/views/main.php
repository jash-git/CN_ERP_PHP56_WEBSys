...
<div id="hd" class="cf">
  <div class="fl welcome cf">
	  ...
	  <a href="javascrip:void(0);" id="manageAcct">帳號管理</a>
    ...
    <div class="main-wrap cf">
      ...
      <ul class="quick-links">
        <li class="purchase-purchase">
        	<a tabid="purchase-purchase" data-right="PU_ADD" tabTxt="採購單" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invPu?action=initPur')?>"><span></span>采购入库</a>
        </li>
        ...
        <li class="added-service">
			...
			<a href="#" id="feedback11"><span></span>增值服务</a>
        </li>
        <li class="feedback">
        	<a href="#" id="feedback11"><span></span>意见反馈</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="extra-wrap">
      ...
      <div class="list">
        <ul>
            ...
            <li><!--<span class="bulk-import">导入</span>--><a tabid="setting-vendorList" data-right="PUR_QUERY" tabTxt="廠商管理管理" parentOpen="true" rel="pageTab" href="<?=site_url('settings/vendor_list')?>">供应商管理</a></li>
            <li><a tabid="sales-salesList" data-right="SA_QUERY" tabTxt="銷貨紀錄" parentOpen="true" rel="pageTab" href="<?=site_url('scm/invSa?action=initSaleList')?>">銷貨紀錄</a></li>
