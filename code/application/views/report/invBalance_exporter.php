...
<table width="1440px" class="list">
  			<tr><td class='H' align="center" colspan="<?php echo 7 + count($storage)*3?>"><h3>商品库存余额表<h3></td></tr>
  			<tr><td colspan="<?php echo 7 + count($storage)*3?>">日期：<?php echo $beginDate;?>至<?php echo $endDate;?></td></tr>
</table>
  		<table width="1440px" class="list" border="1">
				...
				?>
  				<th width="50" colspan="3"><?php echo $row['name']?></th>
				<?php $i++;}?>
  				</tr>
  				<tr class="link" data-id="0" data-type="BAL">
  				   <td align="center">数量</td>
                   <td align="center">单位成本</td>
				...
				<tr class="link" data-id="0" data-type="BAL">
                   ...
                   <td align="center"><?php echo $uPrice ?> </td>
