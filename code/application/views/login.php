        ...
        <div class="LoginBox">
            ...
            <div class="Loginc">
                <div class="loginInputc">
                    <input type="text" class="logininput" value="<?php echo get_cookie('username')?>" id="username" placeholder="請輸入帳號" />
                </div>
                <div class="loginInputc">
                    <input type="password" class="logininput" id="password" value="<?php echo get_cookie('userpwd')?>" placeholder="請輸入密碼" />
                </div>
            </div>
            <div style="color:red; font-size:20px; margin-top:12px; line-height:20px; display:none;" id="loginerror"></div>
            <div class="checkMMBox">
                <span class="checkbox<?php echo get_cookie('ispwd')==1?'true':'false'?>" id="Checked" onClick="ChechBoxAction(this)" val="<?php echo get_cookie('ispwd')?>">記憶帳號</span>
            </div>
