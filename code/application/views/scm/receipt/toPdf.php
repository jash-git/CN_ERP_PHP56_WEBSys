...
<?php for($t=1; $t<=$countpage; $t++){?>
		...
		<table width="800" align="center">
			<tr height="15" align="left">
				<td width="250" align="left" style="font-family:'宋体'; font-size:14px;height:20px;">销货单位：<?php echo $contactNo.' '.$contactName?> </td>
				<td width="10" ></td>
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
		        <tr style="height:20px">
					...
					<td width="100" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">收款金额</td>
		...
		<table  width="800" align="center">
			<tr height="25" align="left">
				<td width="250" align="left" style="font-family:'宋体'; font-size:14px;height:25px;">付款人:  <?php echo $accountName?></td>
				<td width="200" style="font-family:'宋体'; font-size:14px;height:25px;">收款金额: <?php echo  str_money(abs($totalAmount),2)?></td>
