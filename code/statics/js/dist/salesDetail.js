define(["jquery", "print"], function(a, b, c) {
	...
	function g() {
		...
		var c = [{
			...
			d = "local",
			e = "#";
		n.autoSearch && (d = "json", e = "../report/salesDetail_detail?action=detail"), o.gridReg("grid", c), c = o.conf.grids.grid.colModel, console.log('colModel', c);l("#grid").jqGrid({
			url: e,
			postData: n,
			datatype: d,
			autowidth: !0,
	...
	function k(a) {
		console.log('aaaaa', a);
		l(".no-query").remove(), l(".ui-print").show(), "number" == typeof a && (l("#grid").jqGrid(a), h(), l("#grid").clearGridData(!0)), l("#grid").jqGrid("setGridParam", {
			datatype: "json",
			postData: n,
